...
```bash
$ ARBITER_VERSION=v0.5.0 curl -sSf https://raw.githubusercontent.com/vburnz/mcp-gateway-firewall/main/install.sh | sh
```

To install to a custom directory:

```bash
$ ARBITER_INSTALL_DIR=/usr/local/bin curl -sSf https://raw.githubusercontent.com/vburnz/mcp-gateway-firewall/main/install.sh | sh
```
...
```bash
$ git clone https://github.com/vburnz/mcp-gateway-firewall.git
$ cd arbiter
