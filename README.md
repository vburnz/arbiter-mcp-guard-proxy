...
Generated by Claude Opus 4.6 as an artifact of an exhaustive, multi-month model red teaming exercise, with the intention of providing a defensive, lightweight, deployable artifact to protect users from malicious tool calls (due to poisoned data, survellience signals, etc).
